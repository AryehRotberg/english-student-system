...
export class WritingSubmissionsController {
    constructor(private readonly writingSubmissionsService: WritingSubmissionsService) { }
    ...
    @Post()
    async create(@Body() createWritingSubmissionDto: CreateWritingSubmissionDto) {
        return await this.writingSubmissionsService.create(createWritingSubmissionDto);
    }
    ...
    async update(
        ...
        return await this.writingSubmissionsService.update(id, updateWritingSubmissionDto);
    }
}