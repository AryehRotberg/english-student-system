      ...
      <header className={sticky ? styles.shell : `${styles.shell} ${styles.static}`}>
          ...
          <div className={styles.logoIcon} aria-hidden="true">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                strokeWidth="1.7"
              />
              <path d="M8 3V21" stroke="currentColor" strokeWidth="1.7" />
              <path d="M10.5 7.5H16" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
              <path d="M10.5 11H16" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
              <path d="M10.5 14.5H16" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
            </svg>
          </div>
        ...
        >
          ...
          <div className={styles.mobileProfileRow}>
            <span className={styles.mobileAppName}>English Student System</span>
            <div className={styles.mobileProfileBlock}>
              <span className={styles.mobileProfileName}>{displayName}</span>
          ...
          <button className={styles.mobileLogout} onClick={() => void handleLogout()} type="button">
            Logout
          </button>
        </aside>
      </header>
